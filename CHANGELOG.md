...
- Added `SessionConfiguration` for seeding a session ID, configuring inactivity rotation, and
  receiving main-thread session-ID change callbacks.

**Changed**

- Nothing yet!

- `startNewSession` accepts an optional app-provided session ID; omitted IDs are generated by the SDK.
