...
final class DiagnosticEventReporterTests: XCTestCase {
    ...
    func testSdkAttributes() throws {
        let reporter = DiagnosticEventReporter(outputDir: reportDir!, sdkVersion: "41.5.67", minimumHangSeconds: 2.5)
    ...
    func testDeviceTime() throws {
        ...
        let timestamp = formatter.date(from: "1995-03-11")!
    ...
    func testHangUnderThreshold() throws {
        let reporter = DiagnosticEventReporter(outputDir: reportDir!, sdkVersion: "41.5.67", minimumHangSeconds: 1)
        let formatter = DateFormatter()
        formatter.dateFormat = "yyyy-MM-dd"
        let timestamp = formatter.date(from: "2022-04-07")!
    ...
    func testHangOverThreshold() throws {
        ...
        let formatter = DateFormatter()
        formatter.dateFormat = "yyyy-MM-dd"
        let timestamp = formatter.date(from: "2008-11-25")!
        let imageOffset: UInt64 = 165304
        let imageOffset2: UInt64 = 126721
...
final class MockDiagnosticPayload: MXDiagnosticPayload {
    ...
    override var crashDiagnostics: [MXCrashDiagnostic]? {
        get {
            return mockCrashDiagnostics
        }
    }
    override var hangDiagnostics: [MXHangDiagnostic]? {
        get {
            return mockHangDiagnostics
        }
    }
    override var timeStampEnd: Date {
        get {
            return mockTimestampEnd
        }
    }
...
final class MockObjectiveCReason: MXCrashDiagnosticObjectiveCExceptionReason {
    ...
    override var composedMessage: String {
        get {
            return mockMessage
        }
    }
