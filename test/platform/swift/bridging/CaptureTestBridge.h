...
const char *server_instance_wait_for_handshake(test_server_handle handle, stream_id stream_id);
const char *server_instance_await_handshake(test_server_handle handle, stream_id stream_id);
bool server_instance_await_stream_closed(test_server_handle handle, stream_id stream_id,
                                         int64_t wait_time_ms);
void server_instance_send_configuration(test_server_handle handle, stream_id stream_id);
const char *server_instance_await_configuration_ack(test_server_handle handle, stream_id stream_id);
const char *server_instance_configure_aggressive_uploads(test_server_handle handle,
                                                         stream_id stream_id);
...
void test_helpers_free_string(char *ptr);
