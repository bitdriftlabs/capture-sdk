...
class WebViewSettingsDialog(
    ...
    fun WebViewSettingsDialog(
        ...
        val isFullJsMode = instrumentationMode == WebViewInstrumentationMode.FULL_WITH_JAVASCRIPT
    ...
    fun InstrumentationModeSelector(
        ...
        Column(
            ...
            ModeOption(
                mode = WebViewInstrumentationMode.FULL_WITH_JAVASCRIPT,
                title = "Full with JavaScript",
                description = "Enables JavaScript for rich telemetry. Use with caution.",
                isSelected = selectedMode == WebViewInstrumentationMode.FULL_WITH_JAVASCRIPT,
                onClick = { onModeSelected(WebViewInstrumentationMode.FULL_WITH_JAVASCRIPT) },
                isWarning = true,
            )
        }
    }
