 ...
 *
 * - **NATIVE_ONLY**: Uses native WebViewClient callbacks. No JavaScript enabled is required.
 *
 * - **FULL_WITH_JAVASCRIPT**: Injects a JavaScript bridge for rich telemetry including
...
internal object WebViewCapture {
    ...
    /**
     * Instruments a WebView based on the configured [WebViewInstrumentationMode].
     *
     ...
     * - For FULL_WITH_JAVASCRIPT mode: androidx.webkit library must be available
     *
