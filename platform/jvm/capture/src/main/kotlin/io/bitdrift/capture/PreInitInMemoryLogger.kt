...
internal class PreInitInMemoryLogger : ILogger {
    ...
    private val replayLogger = AtomicReference<IInternalLogger?>()
    ...
    private sealed interface BufferedCall {
        ...
        data class StartNewSession(
            ...
            override val sizeBytes = sessionId?.let { sized(it) } ?: CALL_OVERHEAD_BYTES
