...
internal class LoggerImpl(
    ...
    private val crashReportingState: CrashReporter.CrashReportingState,
) : ILogger {
    ...
    private fun handleCrashReporterState() {
        if (crashReportingState is CrashReporter.CrashReportingState.Completed.ProcessingFailure) {
            // TODO(FranAguilera): BIT-4830. Report status of initCrashReporting call (if any) and its duration
            errorHandler.handleError(crashReportingState.message, crashReportingState.throwable)
        }
    }
}
