...
object Capture {
    ...
    private val inMemoryLogger by lazy { InMemoryLogger() }
    ...
    fun logger(): ILogger? =
        when (val state = default.get()) {
            ...
            is LoggerState.Starting -> state.inMemoryLogger
    ...
    object Logger {
        ...
        internal fun start(
            ...
            if (default.compareAndSet(LoggerState.NotStarted, LoggerState.Starting(inMemoryLogger))) {
