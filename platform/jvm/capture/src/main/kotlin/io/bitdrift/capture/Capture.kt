 ...
 */
fun interface ICaptureStartListener {
    /**
...
object Capture {
    ...
    object Logger {
         ...
         * @param captureStartListener optional Listener that emits changes to [LoggerState].
         *
         */
        @Synchronized
        @JvmStatic
        ...
        internal fun start(
            ...
            if (apiKey.isEmpty()) {
                ...
                default
                    ...
                    .apply {
                        captureStartListener?.onLoggerStateUpdate(default.get())
                    }
                return
            }
