...
import io.bitdrift.capture.Capture.Logger.startAsync
...
object Capture {
    ...
    object Logger {
         ...
         *                     before [startAsync] returns. When an [executor] is provided, [startAsync] returns
        ...
        internal fun start(
           ...
           // TODO: Start must remain the same
        }
         ...
         * via [CaptureResult.Success] to the `startResult` callback passed to [startAsync].
         */
        @JvmStatic
         ...
         *
         * Must be called after [startAsync]. Returns `null` if the logger is not initialized.
         *
         */
        @JvmStatic
    ...
    private fun initSdk(
        ...
        val executor = CaptureDispatchers.CommonBackground.executorService
        val initAction =
            Runnable {
                try {
                    ...
                    startResult.invokeCatchingOrThrowOnDebug(CaptureResult.Success(loggerImpl), executor)
        ...
        runCatching {
            ...
            reportStartFailure(
                errorDetails = "Executor rejected SDK init: ${executorFailure.message}",
                throwable = executorFailure,
                startResult = startResult,
            )
        }
    }
