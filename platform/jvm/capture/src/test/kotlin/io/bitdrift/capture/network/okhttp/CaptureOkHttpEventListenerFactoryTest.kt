...
class CaptureOkHttpEventListenerFactoryTest {
    ...
    fun testTraceHeadersBecomeSpanFields() {
        ...
        assertThat(requestInfo.arrayFields[CaptureTracing.TRACE_ID_FIELD_KEY].toString()).isEqualTo(traceId)
        assertThat(responseInfo.arrayFields[CaptureTracing.TRACE_ID_FIELD_KEY].toString()).isEqualTo(traceId)
    }
