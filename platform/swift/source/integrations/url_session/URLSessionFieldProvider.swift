...
///
/// This protocol allows you to provide fields for both requests and responses. You can implement
/// one or both methods depending on your needs. Methods you don't override will return empty dictionaries.
public protocol URLSessionFieldProvider {
...
public extension URLSessionFieldProvider {
