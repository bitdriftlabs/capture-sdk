...
public final class Logger {
    ...
    static var crashReporterInitResult: CrashReporterInitResult = (.notInitialized, 0)
    ...
    )
    {
        ...
        defer {
            ...
            let fields: Fields = [
                "_crash_reporting_state": "\(Logger.crashReporterInitResult.0)",
                "_crash_reporting_duration_ms": Logger.crashReporterInitResult.1
            ]
    ...
    static func reportConfigPath() -> URL? {
        return captureSDKDirectory()?
            .appendingPathComponent("reports/directories", isDirectory: false)
    }
