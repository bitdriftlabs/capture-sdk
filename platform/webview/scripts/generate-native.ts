...
const CONFIG_PLACEHOLDER =
  "/* @magic __BITDRIFT_WEBVIEW_CONFIG_PLACEHOLDER__ */";
...
if (!bundleContent.includes(CONFIG_PLACEHOLDER)) {
  console.error(
    `Error: Bundle does not contain expected placeholder: ${CONFIG_PLACEHOLDER}`,
  );
...
const afterPlaceholder = bundleContent.substring(
  placeholderIndex + CONFIG_PLACEHOLDER.length,
);
