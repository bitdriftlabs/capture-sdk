...
// Escape for Swift multiline string (triple quotes)
const escapeForSwift = (content: string): string => {
    // In Swift multiline strings, we need to escape backslashes and interpolation
    // Backslashes need to be escaped as \\
    // String interpolation \() needs to be escaped
    return content
        .replace(/\\/g, '\\\\')
        .replace(/\\\\\(/g, '\\('); // Keep existing escaped parentheses as-is
};
...
// Generate Swift file
const swiftContent = `${licenseHeader}// AUTO-GENERATED FILE - DO NOT EDIT
// Generated by: npm run generate
// Source: platform/webview/src/
...
${escapeForSwift(beforePlaceholder)}
"""
